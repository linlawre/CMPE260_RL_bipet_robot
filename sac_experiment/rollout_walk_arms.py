...
# DEFAULT_MODEL_PATH = os.path.join(BASE_DIR, "models_sac_walk_arms", "sac_stand_arms_finals.zip")
DEFAULT_MODEL_PATH = os.path.join(BASE_DIR, "models_sac_walk_arms", "best_model.zip")
